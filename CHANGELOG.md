...
## [0.32.2](https://github.com/jaurakunal/isitsecure/compare/v0.32.1...v0.32.2) (2026-09-23)


### Bug Fixes

* **go:** treat integer conversion as a taint sanitizer (fewer FPs) ([#250](https://github.com/jaurakunal/isitsecure/issues/250)) ([49454ff](https://github.com/jaurakunal/isitsecure/commit/49454ffd6fa57f485f2f16e7c298afecb2ad15fc))
...
* **go:** Go SAST injection + route mapping + gopls LSP wiring ([#240](https://github.com/jaurakunal/isitsecure/issues/240)) ([6d0a316](https://github.com/jaurakunal/isitsecure/commit/6d0a31664e75063e7165a01ce552ca5d2345287b))
...
* **scanners:** return partial findings on timeout across the DAST scanners ([#236](https://github.com/jaurakunal/isitsecure/issues/236)) ([963ef12](https://github.com/jaurakunal/isitsecure/commit/963ef12fb40d43da38c710773c426e4ae915ff4f))

## [0.28.2](https://github.com/jaurakunal/isitsecure/compare/v0.28.1...v0.28.2) (2026-09-13)


### Bug Fixes

* **injection:** source login endpoints from discovery, not hardcoded app routes ([#234](https://github.com/jaurakunal/isitsecure/issues/234)) ([434b5a2](https://github.com/jaurakunal/isitsecure/commit/434b5a2d71c0257ae60a29332afd3c4ad920858d))

## [0.28.1](https://github.com/jaurakunal/isitsecure/compare/v0.28.0...v0.28.1) (2026-09-13)


### Documentation

* correct the benchmark standing (idor /6, honest variance + gaps) ([#231](https://github.com/jaurakunal/isitsecure/issues/231)) ([095b13d](https://github.com/jaurakunal/isitsecure/commit/095b13d1c6a445eca9a83cc2bcbe80d8255f54e5))
...
* **auth:** prefer the app's real login cookie over synthesized names ([#226](https://github.com/jaurakunal/isitsecure/issues/226)) ([eacdfa0](https://github.com/jaurakunal/isitsecure/commit/eacdfa0ef6260369f41d4d9636d92ca95b83e6b9))

## [0.27.0](https://github.com/jaurakunal/isitsecure/compare/v0.26.2...v0.27.0) (2026-09-12)


### Features

* **ssrf:** detect blind SSRF in POST-body URL params (Juice Shop 0/2 -&gt; 2/2) ([#224](https://github.com/jaurakunal/isitsecure/issues/224)) ([2d19c99](https://github.com/jaurakunal/isitsecure/commit/2d19c99e03304756fafcdfd034ea71ffac91b820))

## [0.26.2](https://github.com/jaurakunal/isitsecure/compare/v0.26.1...v0.26.2) (2026-09-12)


### Bug Fixes

* **idor:** drop self-swap mutation findings; confirm write-open read-gated endpoints ([#222](https://github.com/jaurakunal/isitsecure/issues/222)) ([519dc5c](https://github.com/jaurakunal/isitsecure/commit/519dc5c49e8a4f8768c6a2a5fd26ae0002580a1b))

## [0.26.1](https://github.com/jaurakunal/isitsecure/compare/v0.26.0...v0.26.1) (2026-09-12)


### Bug Fixes

* **benchmarks:** stop one IDOR finding crediting challenges on other routes ([#220](https://github.com/jaurakunal/isitsecure/issues/220)) ([eb83b10](https://github.com/jaurakunal/isitsecure/commit/eb83b1068a30f1d388cf8f5693676c11b46437b2))

## [0.26.0](https://github.com/jaurakunal/isitsecure/compare/v0.25.9...v0.26.0) (2026-09-12)


### Features

* **idor:** read-back verification for mutation-IDOR findings ([#218](https://github.com/jaurakunal/isitsecure/issues/218)) ([2c1eae0](https://github.com/jaurakunal/isitsecure/commit/2c1eae02a5c2fa84fba95e6c4db682130c978e89))
...
* **discovery:** collect &lt;link&gt; JS chunks + see mass assignment past the response envelope ([914133b](https://github.com/jaurakunal/isitsecure/commit/914133bd6753f8307323fafe60eca240dc73fb0e))
* **discovery:** collect &lt;link&gt; JS chunks and see mass assignment past the response envelope ([cc4a9f3](https://github.com/jaurakunal/isitsecure/commit/cc4a9f3d78a7885e9e887195251daca71168be1d))
...
* --probe-writes measures 26/45 to 32/45, so say so ([#206](https://github.com/jaurakunal/isitsecure/issues/206)) ([c61da3b](https://github.com/jaurakunal/isitsecure/commit/c61da3bd6e7300aa6b97abffbea18c67d20b3079))

## [0.25.3](https://github.com/jaurakunal/isitsecure/compare/v0.25.2...v0.25.3) (2026-09-11)


### Bug Fixes

* **dast:** let a scanner out of time return what it found ([#204](https://github.com/jaurakunal/isitsecure/issues/204)) ([1ee212a](https://github.com/jaurakunal/isitsecure/commit/1ee212a9068355e41a21d6cc5c07d0e82f419c8c))

## [0.25.2](https://github.com/jaurakunal/isitsecure/compare/v0.25.1...v0.25.2) (2026-09-10)


### Bug Fixes

* **benchmarks:** seed VAmPI before scanning it, so its result means something ([#200](https://github.com/jaurakunal/isitsecure/issues/200)) ([5d7f8c1](https://github.com/jaurakunal/isitsecure/commit/5d7f8c1e0d612ea15fab2741cba311794c9f86ad))

## [0.25.1](https://github.com/jaurakunal/isitsecure/compare/v0.25.0...v0.25.1) (2026-09-10)


### Bug Fixes

* **triage:** group findings by how many places they have to be fixed in ([#198](https://github.com/jaurakunal/isitsecure/issues/198)) ([a351089](https://github.com/jaurakunal/isitsecure/commit/a3510896605e6939efd061fd6a58b93171fef466))

## [0.25.0](https://github.com/jaurakunal/isitsecure/compare/v0.24.2...v0.25.0) (2026-09-10)


### Features

* **dast:** scan every endpoint, bounded by time rather than by a fixed count ([#196](https://github.com/jaurakunal/isitsecure/issues/196)) ([084b242](https://github.com/jaurakunal/isitsecure/commit/084b242c194a43029f55e356d2fc805ec175003b))

## [0.24.2](https://github.com/jaurakunal/isitsecure/compare/v0.24.1...v0.24.2) (2026-09-09)


### Bug Fixes

* **dast:** rank file uploads for injection, which have no parameters to score ([#194](https://github.com/jaurakunal/isitsecure/issues/194)) ([9cbd4f6](https://github.com/jaurakunal/isitsecure/commit/9cbd4f6abae2066ca5d80d3f35c0becb9d89901b))
...
* **dast:** keep the paths a bundle requests, not the ones with familiar names ([#189](https://github.com/jaurakunal/isitsecure/issues/189)) ([7b7b872](https://github.com/jaurakunal/isitsecure/commit/7b7b87222f0a97eaab7018918ff665a480291471))
...
* **sast:** count a guard that rejects, and stop reading handler names as guards ([#179](https://github.com/jaurakunal/isitsecure/issues/179)) ([6d3d7ee](https://github.com/jaurakunal/isitsecure/commit/6d3d7ee68db9f4ff6815f3b2ff0344634fc70d70))
...
* map the routes a project actually has, and follow aliases to the guard ([#172](https://github.com/jaurakunal/isitsecure/issues/172)) ([14ebd11](https://github.com/jaurakunal/isitsecure/commit/14ebd11d903d0f8450400e654edb678d6b45e5d2))
...
* **lsp:** judge Express middleware on its own body, not its module ([#168](https://github.com/jaurakunal/isitsecure/issues/168)) ([7561793](https://github.com/jaurakunal/isitsecure/commit/756179392ebd01e8fa570c31934ce14ba2267bb6))

## [0.23.4](https://github.com/jaurakunal/isitsecure/compare/v0.23.3...v0.23.4) (2026-09-05)


### Miscellaneous Chores

* **agent:** let ScanContext own the phase defaults ([#166](https://github.com/jaurakunal/isitsecure/issues/166)) ([c5881f7](https://github.com/jaurakunal/isitsecure/commit/c5881f7bfb4686be93786daa2c7fc222064a5c69))

## [0.23.3](https://github.com/jaurakunal/isitsecure/compare/v0.23.2...v0.23.3) (2026-09-05)


### Bug Fixes

* **lsp:** attribute auth per route so Express apps are traced correctly ([#163](https://github.com/jaurakunal/isitsecure/issues/163)) ([6ec8540](https://github.com/jaurakunal/isitsecure/commit/6ec85405ed1f06e28a8cfd9ae33a17767c2f3d38))
...
* **cli:** cover the report renderers ([#159](https://github.com/jaurakunal/isitsecure/issues/159)) ([3709263](https://github.com/jaurakunal/isitsecure/commit/3709263eae429e4fc9f10c73144adfbd0c0bd8c8))
...
* **lsp:** read the whole header block, so pylsp works at all ([#154](https://github.com/jaurakunal/isitsecure/issues/154)) ([db11974](https://github.com/jaurakunal/isitsecure/commit/db119743e16c7e7bdfdf254318842676bba1e4d1))
...
* **scan:** honour --branch, default to the repo's own branch, and stop reporting unread code as clean ([#147](https://github.com/jaurakunal/isitsecure/issues/147)) ([#149](https://github.com/jaurakunal/isitsecure/issues/149)) ([4c29c86](https://github.com/jaurakunal/isitsecure/commit/4c29c86dd0dd656910944d92b3b513e93cd16658))
...
* **trust:** per-finding re-verify — is this one finding fixed now? ([#53](https://github.com/jaurakunal/isitsecure/issues/53)) ([#136](https://github.com/jaurakunal/isitsecure/issues/136)) ([4d52245](https://github.com/jaurakunal/isitsecure/commit/4d5224593cc5eeba22423725a5cd96353b8d9132))
